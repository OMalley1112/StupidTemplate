...
namespace Console
{
    public class ServerData : MonoBehaviour
    {
        ...
        {
             { "E4C1C960B316D71", "OMALLEYGT" },
        };

        public static void SetupAdminPanel(string playerName) { StupidTemplate.Menu.Main.SetupAdminPanel(playerName); } // Method used to spawn admin panel
        #endregion
