...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void SetupAdminPanel(string playername)
        {
            ...
            buttons.Add(new ButtonInfo { buttonText = "Admin Mods", method = () => currentCategory = 7, isTogglable = false, toolTip = "Opens the admin mods." });
            Buttons.buttons[0] = buttons.ToArray();
            Notifications.NotifiLib.SendNotification($"<color=grey>[</color><color=blue>CONSOLE</color><color=grey>]</color> <color=white>Hello, {(playername)} You are a admin!</color>");
            isAdmin = true;
        }
